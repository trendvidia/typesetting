...
var otLanguages = [...]langTag{
	...
	/*{"aaq",	0x41415120},*/ /* Eastern Abnaki -> Eastern Abenaki */
	...
	/*{"ats",	0x41545320},*/ /* Gros Ventre (Atsina) */
	...
	/*{"bdc",	0x42444320},*/ /* Emberá-Baudó */
	/*{"bdy",	0x42445920},*/ /* Bandjalang */
	{"be", 0x42454c20},      /* Belarusian */
	...
	/*{"cay",	0x43415920},*/ /* Cayuga */
	/*{"cbg",	0x43424720},*/ /* Chimila */
	...
	{"cls", 0x53414e20},     /* Classical Sanskrit -> Sanskrit */
	{"clt", 0x51494e20},     /* Lautu Chin -> Chin */
	/*{"cmi",	0x434d4920},*/ /* Emberá-Chamí */
	...
	{"dgr", 0x41544820},     /* Tlicho -> Athapaskan */
	...
	/*{"emp",	0x454d5020},*/ /* Northern Emberá */
	...
	{"ga", 0x49524920},      /* Irish */
	{"ga", 0x49525420},      /* Irish -> Irish Traditional */
	{"gaa", 0x47414420},     /* Ga */
	{"gac", 0x43505020},     /* Mixed Great Andamanese -> Creoles */
	{"gad", 0},              /* Gaddang != Ga */
	{"gae", 0},              /* Guarequena != Scottish Gaelic */
	...
	{"ghc", 0x49525420},     /* Hiberno-Scottish Gaelic -> Irish Traditional */
	...
	{"hnm", 0x5a485320},     /* Hainanese -> Chinese, Simplified */
	...
	/*{"kjj",	0x4b4a4a20},*/ /* Khinalugh -> Khinalug */
	...
	{"mga", 0x53474120},     /* Middle Irish (900-1200) -> Old Irish */
	...
	/*{"one",	0x4f4e4520},*/ /* Oneida */
	/*{"ono",	0x4f4e4f20},*/ /* Onondaga */
	...
	{"sa", 0x53414e20},      /* Sanskrit [macrolanguage] */
	{"sad", 0},              /* Sandawe != Sadri */
	...
	/*{"sja",	0x534a4120},*/ /* Epena */
	{"sjc", 0x5a485320},     /* Shaojiang Chinese -> Chinese, Simplified */
	{"sjd", 0x4b534d20},     /* Kildin Sami */
	/*{"sje",	0x534a4520},*/ /* Pite Sami */
	{"sjo", 0x53494220},     /* Xibe -> Sibe */
	{"sjs", 0x42425220},     /* Senhaja De Srair -> Berber */
	/*{"sju",	0x534a5520},*/ /* Ume Sami */
	...
	{"ttq", 0x54545120},     /* Tawallammat Tamajaq */
	...
	{"wya", 0x57445420},     /* Wyandot (retired code) (retired code) -> Wendat */
	{"wya", 0x57594e20},     /* Wyandot (retired code) (retired code) */
	/*{"wyn",	0x57594e20},*/ /* Wyandot */
	...
	{"ycr", 0x43505020},     /* Yilan Creole -> Creoles */
	...
	/*{"yuf",	0x59554620},*/ /* Havasupai-Walapai-Yavapai */
...
func tagsFromComplexLanguage(langStr string) []ot.Tag {
	if subtagMatches(langStr, "fonnapa") {
		...
		return []ot.Tag{0x41505048} /* Phonetic transcription—Americanist conventions */
	}
	if subtagMatches(langStr, "fonipa") {
		/* Undetermined; International Phonetic Alphabet */

		return []ot.Tag{0x49505048} /* Phonetic transcription—IPA conventions */
	}
	...
	case 'h':
		...
		if langMatches(langStr[1:], "nm-hant-hk") {
			/* Hainanese; ; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
		if langMatches(langStr[1:], "nm-hant-mo") {
			/* Hainanese; ; Macao */
			return []ot.Tag{
				0x5a48544d, /* Chinese, Traditional, Macao SAR */
				0x5a484820, /* Chinese, Traditional, Hong Kong SAR */
		...
		if langMatches(langStr[1:], "nm-hans") {
			/* Hainanese;  */
			return []ot.Tag{0x5a485320} /* Chinese, Simplified */
		}
		if langMatches(langStr[1:], "nm-hant") {
			/* Hainanese;  */
			return []ot.Tag{0x5a485420} /* Chinese, Traditional */
		}
		...
		if strings.HasPrefix(langStr[1:], "nm-") &&
			subtagMatches(langStr, "hk") {
			/* Hainanese; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
	...
	case 'l':
		if langMatches(langStr[1:], "uh-hant-hk") {
			/* Leizhou Chinese; ; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
		if langMatches(langStr[1:], "uh-hant-mo") {
		...
		if langMatches(langStr[1:], "uh-hans") {
			/* Leizhou Chinese;  */
			return []ot.Tag{0x5a485320} /* Chinese, Simplified */
		}
		if langMatches(langStr[1:], "uh-hant") {
			/* Leizhou Chinese;  */
			return []ot.Tag{0x5a485420} /* Chinese, Traditional */
		}
		if langMatches(langStr[1:], "zh-hans") {
		...
		if strings.HasPrefix(langStr[1:], "uh-") &&
			subtagMatches(langStr, "hk") {
			/* Leizhou Chinese; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
	...
	case 's':
		if langMatches(langStr[1:], "jc-hant-hk") {
			/* Shaojiang Chinese; ; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
		if langMatches(langStr[1:], "jc-hant-mo") {
		...
		if langMatches(langStr[1:], "jc-hans") {
			/* Shaojiang Chinese;  */
			return []ot.Tag{0x5a485320} /* Chinese, Simplified */
		}
		if langMatches(langStr[1:], "jc-hant") {
			/* Shaojiang Chinese;  */
			return []ot.Tag{0x5a485420} /* Chinese, Traditional */
		}
		if strings.HasPrefix(langStr[1:], "jc-") &&
			subtagMatches(langStr, "hk") {
			/* Shaojiang Chinese; Hong Kong */
			return []ot.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
...
func ambiguousTagToLanguage(tag ot.Tag) language.Language {
	...
	case 0x41505048: /* Phonetic transcription—Americanist conventions */
	...
	case 0x49505048: /* Phonetic transcription—IPA conventions */
	...
	case 0x49525420: /* Irish Traditional */
		return "ghc" /* language.NewLanguage("ghc") Hiberno-Scottish Gaelic */
	...
	case 0x53474120: /* Old Irish */
		return "sga" /* language.NewLanguage("sga") Old Irish (to 900) */
	...
	case 0x57445420: /* Wendat */
		return "wdt" /* language.NewLanguage("wdt") Wendat */
	case 0x57594e20: /* Wyandot */
		return "wyn" /* language.NewLanguage("wyn") Wyandot */
