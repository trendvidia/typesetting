...
var familySubstitution = []substitution{
	...
	{
		test:               familyEquals("Helvetica LT Std"),
	...
	{
		test:               familyEquals("Helvetica"),
		additionalFamilies: []string{"Helvetica LT Std"},
		op:                 opAppend,
		importance:         'e',
	},
	// confs/30-metric-aliases.conf (Set substitutions for similar/metric-compatible families)
	...
	{
		test:               familyEquals("Courier"),
		additionalFamilies: []string{"Courier Std"},
		op:                 opAppend,
		importance:         'e',
	},
	// confs/30-metric-aliases.conf (Set substitutions for similar/metric-compatible families)
	...
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Arabic UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Bengali UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Devanagari UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Gujarati UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Gurmukhi UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Kannada UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Khmer UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Lao UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Malayalam UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Myanmar UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Oriya UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Sinhala UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Tamil UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Telugu UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Noto Sans Thai UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Leelawadee UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Yu Gothic UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("MS UI Gothic"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Microsoft JhengHei UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/40-nonlatin.conf (Set substitutions for non-Latin fonts)
	{
		test:               familyEquals("Microsoft YaHei UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	// confs/45-generic.conf (Set substitutions for emoji/math fonts)
	{
		test:               langEqualsAndNoFamily{lang: language.LangUnd_Zsye, family: "emoji"},
		additionalFamilies: []string{"emoji"},
		op:                 opAppendLast,
		importance:         's',
	},
	...
	// confs/45-generic.conf (Set substitutions for emoji/math fonts)
	{
		test:               langEqualsAndNoFamily{lang: language.LangUnd_Zmth, family: "math"},
		additionalFamilies: []string{"math"},
		op:                 opAppendLast,
		importance:         's',
	},
	...
	// confs/45-latin.conf (Set substitutions for Latin fonts)
	{
		test:               familyEquals("Noto Sans UI"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	// confs/45-latin.conf (Set substitutions for Latin fonts)
	{
		test:               familyEquals("Segoe UI Historic"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	// confs/45-latin.conf (Set substitutions for Latin fonts)
	{
		test:               familyEquals("Segoe UI Symbol"),
		additionalFamilies: []string{"system-ui"},
		op:                 opAppendLast,
		importance:         'w',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangAr, family: "sans-serif"},
	...
	// confs/56-language-selector-ar.conf
	{
		test:               langAndFamilyEqual{lang: language.LangAr, family: "serif"},
	...
	// confs/60-generic.conf (Set preferable fonts for emoji/math fonts)
	{
		...
		additionalFamilies: []string{"Noto Color Emoji", "Apple Color Emoji", "Segoe UI Emoji", "Twitter Color Emoji", "EmojiOne Mozilla", "Emoji Two", "JoyPixels", "Emoji One", "Noto Emoji", "Android Emoji"},
		op:                 opPrepend,
		importance:         'e',
	},
	// confs/60-generic.conf (Set preferable fonts for emoji/math fonts)
	...
	{
		test:               familyEquals("serif"),
		additionalFamilies: []string{"Noto Serif", "DejaVu Serif", "Times New Roman", "Thorndale AMT", "Luxi Serif", "Nimbus Roman No9 L", "Nimbus Roman", "Times"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/60-latin.conf (Set preferable fonts for Latin)
	{
		test:               familyEquals("sans-serif"),
		additionalFamilies: []string{"Noto Sans", "DejaVu Sans", "Verdana", "Arial", "Albany AMT", "Luxi Sans", "Nimbus Sans L", "Nimbus Sans", "Helvetica", "Lucida Sans Unicode", "BPG Glaho International", "Tahoma"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/60-latin.conf (Set preferable fonts for Latin)
	...
	// confs/60-latin.conf (Set preferable fonts for Latin)
	{
		test:               familyEquals("system-ui"),
		additionalFamilies: []string{"Cantarell", "Noto Sans UI", "Segoe UI", "Segoe UI Historic", "Segoe UI Symbol"},
		op:                 opPrepend,
		importance:         'w',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangBn, family: "sans-serif"},
	...
	// confs/65-0-fonts-beng-extra.conf
	{
		test:               langAndFamilyEqual{lang: language.LangBn, family: "serif"},
	...
	// confs/65-0-fonts-beng-extra.conf
	{
		test:               langAndFamilyEqual{lang: language.LangAs, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangPa, family: "sans-serif"},
	...
	// confs/65-0-fonts-guru-extra.conf
	{
		test:               langAndFamilyEqual{lang: language.LangPa, family: "serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangOr, family: "sans-serif"},
	...
	// confs/65-0-fonts-orya-extra.conf
	{
		test:               langAndFamilyEqual{lang: language.LangOr, family: "serif"},
		additionalFamilies: []string{"utkal"},
		op:                 opAppend,
		importance:         'e',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangTe, family: "sans-serif"},
	...
	// confs/65-0-fonts-telu-extra.conf
	{
		test:               langAndFamilyEqual{lang: language.LangTe, family: "serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangMl, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangMl, family: "serif"},
	...
	// confs/65-fonts-takao-pgothic.conf
	{
		test:               langAndFamilyEqual{lang: language.LangJa, family: "sans-serif"},
	...
	{
		test:               familyEquals("serif"),
		additionalFamilies: []string{"Artsounk", "BPG UTF8 M", "Kinnari", "Norasi", "Frank Ruehl", "Dror", "JG LaoTimes", "Saysettha Unicode", "Pigiarniq", "B Davat", "B Compset", "Kacst-Qr", "Urdu Nastaliq Unicode", "Raghindi", "Mukti Narrow", "malayalam", "Sampige", "padmaa", "Hapax Berbère", "MS Mincho", "SimSun", "PMingLiu", "WenQuanYi Zen Hei", "WenQuanYi Bitmap Song", "AR PL ShanHeiSun Uni", "AR PL New Sung", "ZYSong18030", "HanyiSong", "Hiragino Mincho ProN", "Songti SC", "Songti TC", "SimSong", "MgOpen Canonica", "Sazanami Mincho", "IPAMonaMincho", "IPAMincho", "Kochi Mincho", "AR PL SungtiL GB", "AR PL Mingti2L Big5", "AR PL Zenkai Uni", "ＭＳ 明朝", "ZYSong18030", "NanumMyeongjo", "UnBatang", "Baekmuk Batang", "AppleMyungjo", "KacstQura", "Frank Ruehl CLM", "Lohit Bengali", "Lohit Gujarati", "Lohit Hindi", "Lohit Marathi", "Lohit Maithili", "Lohit Kashmiri", "Lohit Konkani", "Lohit Nepali", "Lohit Sindhi", "Lohit Punjabi", "Lohit Tamil", "Rachana", "Lohit Malayalam", "Lohit Kannada", "Lohit Telugu", "Lohit Oriya", "LKLUG"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/65-nonlatin.conf (Set preferable fonts for non-Latin)
	...
	{
		test:               familyEquals("system-ui"),
		additionalFamilies: []string{"Noto Sans Arabic UI", "Noto Sans Bengali UI", "Noto Sans Devanagari UI", "Noto Sans Gujarati UI", "Noto Sans Gurmukhi UI", "Noto Sans Kannada UI", "Noto Sans Khmer UI", "Noto Sans Lao UI", "Noto Sans Malayalam UI", "Noto Sans Myanmar UI", "Noto Sans Oriya UI", "Noto Sans Sinhala UI", "Noto Sans Tamil UI", "Noto Sans Telugu UI", "Noto Sans Thai UI", "Leelawadee UI", "Nirmala UI", "Yu Gothic UI", "Meiryo UI", "MS UI Gothic", "Khmer UI", "Lao UI", "Microsoft YaHei UI", "Microsoft JhengHei UI"},
		op:                 opPrepend,
		importance:         'w',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangHi, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangMr, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangKok, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangKs_Devanagari, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangSd_Devanagari, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangMai, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangNe, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangBrx, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangDoi, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangSa, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	// confs/66-lohit-devanagari.conf
	{
		test:               langAndFamilyEqual{lang: language.LangSat, family: "sans-serif"},
		additionalFamilies: []string{"Lohit Devanagari"},
		op:                 opPrepend,
		importance:         'w',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangGu, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangKn, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangTa, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangMl_In, family: "sans-serif"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangMl_In, family: "cursive"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangMl_In, family: "fantasy"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Cn, family: "serif"},
	...
	// confs/69-language-selector-zh-cn.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Cn, family: "sans-serif"},
	...
	// confs/69-language-selector-zh-cn.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Cn, family: "monospace"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Hk, family: "serif"},
	...
	// confs/69-language-selector-zh-hk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Hk, family: "sans-serif"},
	...
	// confs/69-language-selector-zh-hk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Hk, family: "monospace"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Mo, family: "serif"},
		additionalFamilies: []string{"Noto Serif CJK TC", "AR PL UMing HK", "AR PL New Sung", "HYSong", "WenQuanYi Bitmap Song", "AR PL UKai HK", "AR PL ZenKai Uni"},
		op:                 opPrepend,
		importance:         's',
	},
	// confs/69-language-selector-zh-mo.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Mo, family: "sans-serif"},
	...
	// confs/69-language-selector-zh-mo.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Mo, family: "monospace"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Sg, family: "serif"},
		additionalFamilies: []string{"Noto Serif CJK SC", "HYSong", "AR PL UMing CN", "AR PL UMing HK", "AR PL New Sung", "WenQuanYi Bitmap Song", "AR PL UKai CN", "AR PL ZenKai Uni"},
		op:                 opPrepend,
		importance:         's',
	},
	// confs/69-language-selector-zh-sg.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Sg, family: "sans-serif"},
		additionalFamilies: []string{"Noto Sans CJK SC", "WenQuanYi Zen Hei", "HYSong", "AR PL UMing CN", "AR PL UMing HK", "AR PL New Sung", "AR PL UKai CN", "AR PL ZenKai Uni"},
		op:                 opPrepend,
		importance:         's',
	},
	// confs/69-language-selector-zh-sg.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Sg, family: "monospace"},
		additionalFamilies: []string{"DejaVu Sans Mono", "Noto Sans Mono CJK SC", "WenQuanYi Zen Hei Mono", "HYSong", "AR PL UMing CN", "AR PL UMing HK", "AR PL New Sung", "AR PL UKai CN", "AR PL ZenKai Uni"},
		op:                 opPrepend,
		importance:         's',
	},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Tw, family: "serif"},
	...
	// confs/69-language-selector-zh-tw.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Tw, family: "sans-serif"},
	...
	// confs/69-language-selector-zh-tw.conf
	{
		test:               langAndFamilyEqual{lang: language.LangZh_Tw, family: "monospace"},
	...
	{
		test:               langAndFamilyEqual{lang: language.LangJa, family: "serif"},
	...
	// confs/70-fonts-noto-cjk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangKo, family: "serif"},
	...
	// confs/70-fonts-noto-cjk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangKo, family: "sans-serif"},
	...
	// confs/70-fonts-noto-cjk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangJa, family: "monospace"},
	...
	// confs/70-fonts-noto-cjk.conf
	{
		test:               langAndFamilyEqual{lang: language.LangKo, family: "monospace"},
